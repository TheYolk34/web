...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        DrugIllness = [
            ...
            {'drug_id': 1, 'illness_id': 1, 'trial': 'Успешно' },
            # Во втором заказе 1 и 2 пользователь
            {'drug_id': 2, 'illness_id': 2, ' trial': 'Успешно' },
            {'drug_id': 2, 'illness_id': 3, ' trial': 'Успешно' },
            # В третьем заказе 1, 2 и 3 пользователь
            {'drug_id': 3, 'illness_id': 4, ' trial': 'Успешно' },
            {'drug_id': 3, 'illness_id': 5, ' trial': 'Успешно' },
            {'drug_id': 3, 'illness_id': 6, ' trial': 'Успешно' },
            # В четвертом заказе только 4 пользователь
            {'drug_id': 4, 'illness_id': 7, ' trial': 'Успешно' },
            # В пятом заказе 4 и 5 пользователь
            {'drug_id': 5, 'illness_id': 8, ' trial': 'Успешно' },
            {'drug_id': 5, 'illness_id': 9, ' trial': 'Успешно' }
        ]

        for od in DrugIllness:
